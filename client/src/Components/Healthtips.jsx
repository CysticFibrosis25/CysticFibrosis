...
const Healthtips = () => {
  return (
    <div className="mb-4 font-dm-sans">
      ...
      <div className="flex flex-col text-2xl md:text-3xl px-6 font-medium tracking-tight items-center text-center justify-center mb-4">
        ...
        {healthtips.map((tip, index) => (
          ...
          >
            <div className="flex flex-col items-start justify-between gap-2 w-full">
              <h3 className="text-2xl font-medium mb-2 text-black tracking-tight">
                {tip.heading}
              </h3>
            ...
            <img
              src={tip.imageUrl}
              alt={tip.heading}
              className="w-24 md:w-32 md:h-32 h-24 object-contain"
            />
          </motion.div>
        ))}
      </div>
